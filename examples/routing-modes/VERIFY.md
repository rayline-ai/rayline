...
supported `--config` routing mode end-to-end with `visual-demo.sh`, **one at a
...
DEMO_HEADLESS=1 RAYLINE_BIN="$RB" ./examples/routing-modes/visual-demo.sh "$MODE" "$PROMPT" >/tmp/v-$MODE.out 2>&1 &
